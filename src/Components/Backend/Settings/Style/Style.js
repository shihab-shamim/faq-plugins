...
const Style = ({ attributes, setAttributes,device }) => {
  ...
  <Background label={__("High Light Color","b-blocks")} isImage={false}  value={styles?.title?.highlightColor} onChange={value=>setAttributes({styles:updateData(styles,value,"title","highlightColor")})}  />
    ...
    <ColorsControl value={styles?.question?.colors} onChange={value=>setAttributes({styles:updateData(styles,value,"question","colors")})}  />
      ...
      initialOpen={false}>
        ...
        <BoxControl label={__("Padding","b-blocks")} values={styles?.answer?.padding}  onChange={(value)=>setAttributes({styles:updateData(styles,value,"answer","padding")})} />
